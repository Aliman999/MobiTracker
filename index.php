    ...
    <div id="canvas">
      <div class="headerContainer">
        <div id="login_status" class="login_menu">
          ...
          <a id="lmLBtn" class="verify_btn lmBtn <?php if($_SESSION["loggedin"]) && $_SESSION["loggedin"] === true){echo "hidden";}) ?>">Login</a>
          <a id="lmSBtn" class="verify_btn <?php if($_SESSION["loggedin"]) && $_SESSION["loggedin"] === true){echo "hidden";}) ?>">Sign Up</a>
