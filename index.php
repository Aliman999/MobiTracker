    ...
    <div id="canvas">
      <div class="headerContainer">
        <div id="login_status" class="login_menu">
          ...
          <?php if($_SESSION["loggedin"] != true){echo "<a id='lmLBtn' class='verify_btn lmBtn'>Login</a>";} ?>
          <?php if($_SESSION["loggedin"] != true){echo "<a id='lmSBtn' class='verify_btn'>Sign Up</a>";} ?>
