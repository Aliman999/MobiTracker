    ...
    <div id="canvas">
      <div class="headerContainer">
        <div id="login_status" class="login_menu">
          ...
          <?php if($_SESSION["loggedin"] === false){echo "<a id='lmLBtn' class='verify_btn lmBtn'>Login</a>";} ?>
          <?php if($_SESSION["loggedin"] === false){echo "<a id='lmSBtn' class='verify_btn'>Sign Up</a>";} ?>
