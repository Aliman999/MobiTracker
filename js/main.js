    ...
    if(readCareers.readyState == 4){
      ...
      for(var x = 0; x<selectedCareer.length; x++){
        if(selectedCareer[x] == 1){
          tags.className = "careers";
          tags.title = Object.keys(selectedCareer[x]);
          tags.src = careers[x];
  ...
  if(session && sessionUser !== node.value){
    ...
    createButton.onclick = function() {
      if(session && commented == 0 && comcount != 3){
        ...
        //Rating
        var star0 = document.getElementById("0");
        ...
        star0.onmouseover = function(){
          star0.src = "src/star.png";
          if(selected == 0 || selected > 0){
            star0.onmouseout = "";
          }else{
            star0.onmouseout = function(){
              star0.src = "src/star-empty.png";
              star1.src = "src/star-empty.png";
              star2.src = "src/star-empty.png";
              star3.src = "src/star-empty.png";
              star4.src = "src/star-empty.png";
            };
          }
        };
