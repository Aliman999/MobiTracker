...
<div id="navMenu" class="navMenu">
  ...
  <div class="eleContainer">
    ...
    <a href="<?php if($base != "contracts"){echo "https://mobitracker.co/contracts";}?>" class="navEle <?php if($base == "contracts"){echo "navActive";} ?>"><img src="https://mobitracker.co/src/contracts.png" class="menuIcon"/><p>Player History</p></a>
    <a href="<?php if($base != "contracts"){echo "https://mobitracker.co/contracts";}?>" class="navEle <?php if($base == "contracts"){echo "navActive";} ?>"><img src="https://mobitracker.co/src/contracts.png" class="menuIcon"/><p>Organization History</p></a>
    ...
    <a href="https://finder.deepspacecrew.com/" class="navEle" target="_blank"><img src="https://mobitracker.co/beta/src/UIF_mtco.png" class="menuIcon"/><p>Universal Item Finder</p></a>
