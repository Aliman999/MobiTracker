...
<div id="navMenu" class="navMenu">
  ...
  <div class="eleContainer">
    ...
    if($_SESSION['privilage'] === true){
      ...
      echo "'><img src='https://mobitracker.co/beta/src/panel.png' class='menuIcon'/><p>Systems</p></a>";
    }
    ?>
    ...
    <a href="https://finder.cornerstonebase.space/" class="navEle" target="_blank"><img src="https://mobitracker.co/beta/src/UIF_mtco.png" class="menuIcon"/><p>Universal Item Finder</p></a>
