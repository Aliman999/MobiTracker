...
<div id="navMenu" class="navMenu">
  ...
  <div class="eleContainer">
    ...
    <a href=" <?php if(!basename($_SERVER['REQUEST_URI']) == "beta"){echo "../contracts";} ?>" class="navEle <?php if(basename($_SERVER['REQUEST_URI']) == "contracts"){echo "navActive";} ?>"><img src="https://mobitracker.co/beta/src/contracts.png" class="menuIcon"/><p>Contracts</p></a>
    <a href=" <?php if(!basename($_SERVER['REQUEST_URI']) == "beta"){echo "../discord";} ?>" class="navEle <?php if(basename($_SERVER['REQUEST_URI']) == "discord"){echo "navActive";} ?>"><img src="https://mobitracker.co/beta/src/discord.png" class="menuIcon"/><p>Discord</p></a>
    <a href=" <?php if(!basename($_SERVER['REQUEST_URI']) == "beta"){echo "../faq";} ?>" class="navEle <?php if(basename($_SERVER['REQUEST_URI']) == "faq"){echo "navActive";} ?>"><img src="https://mobitracker.co/beta/src/faq.png" class="menuIcon"/><p>FAQ</p></a>
