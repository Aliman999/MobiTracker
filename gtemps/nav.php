...
<div id="navMenu" class="navMenu">
  ...
  <div class="eleContainer">
    ...
    <a href="<?php if($base == "discord"){echo "";}else if($base == "beta"){echo "discord";} ?>" class="navEle <?php if($base == "discord"){echo "navActive";} ?>"><img src="https://mobitracker.co/beta/src/discord.png" class="menuIcon"/><p>Discord</p></a>
    <a href="<?php if($base == "faq"){echo "";}else if($base == "beta"){echo "faq";} ?>" class="navEle <?php if($base == "faq"){echo "navActive";} ?>"><img src="https://mobitracker.co/beta/src/faq.png" class="menuIcon"/><p>FAQ</p></a>
