...
<div id="navMenu" class="navMenu">
  ...
  <div class="eleContainer">
    ...
    <a href="<?php if($base == "contracts"){echo "../contracts";}else if($base == "beta"){echo "contracts";} ?>" class="navEle <?php if($base == "contracts"){echo "navActive";} ?>"><img src="https://mobitracker.co/beta/src/contracts.png" class="menuIcon"/><p>Contracts</p></a>
