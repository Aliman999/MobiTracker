...
<div id="navMenu" class="navMenu">
  ...
  <div class="eleContainer">
    <a href="<?php if($base != "beta"){echo "https://mobitracker.co/";} ?>" class="navEle <?php if($base == "beta"){echo "navActive";} ?>"><img src="https://mobitracker.co/src/repHub.png" class="menuIcon"/><p>Reputation Hub</p></a>
    ...
    <a href="https://patreon.com/mobitracker" class="navEle"><img src="https://mobitracker.co/src/patreon.png" class="menuIcon"/><p>Patreon</p></a>
  </div>
</div>
