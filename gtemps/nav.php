...
<div id="navMenu" class="navMenu">
  ...
  <div class="eleContainer">
    ...
    <a href="<?php if($base == "contracts"){echo "../contracts";}else if($base == "beta"){echo "contracts";}else{echo "";} ?>" class="navEle <?php if($base == "contracts"){echo "navActive";} ?>"><img src="https://mobitracker.co/beta/src/contracts.png" class="menuIcon"/><p>Contracts</p></a>
    <a href="<?php if($base == "discord"){echo "../discord";}else if($base == "beta"){echo "discord";} ?>" class="navEle <?php if($base == "discord"){echo "navActive";} ?>"><img src="https://mobitracker.co/beta/src/discord.png" class="menuIcon"/><p>Discord</p></a>
    <a href="<?php if($base == "faq"){echo "../faq";}else if($base == "beta"){echo "faq";} ?>" class="navEle <?php if($base == "faq"){echo "navActive";} ?>"><img src="https://mobitracker.co/beta/src/faq.png" class="menuIcon"/><p>FAQ</p></a>
