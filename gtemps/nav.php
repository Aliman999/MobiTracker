...
<div id="navMenu" class="navMenu">
  ...
  <div class="eleContainer">
    ...
    <a href="<?php if($base != "privacypolicy"){echo "https://mobitracker.co/beta/privacypolicy";}?>" class="navEle <?php if($base == "privacypolicy"){echo "navActive";} ?>"><img src="https://mobitracker.co/beta/src/faq.png" class="menuIcon"/><p>Privacy Policy</p></a>
