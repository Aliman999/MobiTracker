      ...
      <div class="container container-header" id="general">
        <header class="playercard">
          <div>
            ...
            <li>
            <p><strong>Website</strong> refers to MobiTracker, accessible from <a href="https://mobitracker.co" rel="external nofollow noopener" target="_blank">https://mobitracker.co</a></p>
            </li>
            <li>
