    ...
    <div id="canvas">
      ...
      <div class="container container-header" id="general">
        <header class="playercard">
          ...
          <p><strong>Website</strong> refers to MobiTracker, accessible from <a class="highlight" href="https://mobitracker.co" rel="external nofollow noopener" target="_blank">https://mobitracker.co</a></p>
        </header>
      </div>
    </div>
