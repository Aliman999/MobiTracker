      ...
      <div class="container container-header">
        ...
        <div class="setting">
          ...
          <div class="faded">
            ...
            <p><span class="rBold">Badge:</span><br><table><td><span id="Badge" class="subP">Vice Admiral</span></td><td><img class="badgeImg" src="https://robertsspaceindustries.com/media/cs5xmnc9byun2r/heap_thumb/Vice-Admiral.png"></td></table></p>
          </div>
          <div class="faded">
          </div>
        </div>
