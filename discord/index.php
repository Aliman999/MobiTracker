  ...
  <body>
    <div id="navMenu" class="navMenu">
      ...
      <div class="eleContainer">
        <a class="navEle"><img src="../src/repHub.png" class="menuIcon"/><p>Reputation Hub</p></a>
        <a href="contracts" class="navEle"><img src="../src/contracts.png" class="menuIcon"/><p>Contracts</p></a>
        <a href="discord" class="navEle navActive"><img src="../src/discord.png" class="menuIcon"/><p>Discord</p></a>
