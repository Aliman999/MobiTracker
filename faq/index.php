...
<html lang="en" dir="ltr">
  <head>
    ...
    <meta property="og:url" content="https://mobitracker.co/faq" />
  ...
  <body>
    <div id="login_status" class="login_menu">
      ...
      if(isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] === true){
        ...
        echo '<a href="../contracts" class="verify_btn">Contracts</a>';
        echo '<a href="../discord" class="verify_btn">Discord Bot</a>';
        echo '<a class="verify_btn breadCrumbNav">FAQ</a>';
        ...
        echo '<a href="../contracts" class="verify_btn">Contracts</a>';
        echo '<a href="../discord" class="verify_btn">Discord Bot</a>';
        echo '<div class="loginDiv"></div>';
        echo '<a href="../login" class="login_btn">Sign in</a>';
        echo '<a href=../register class="login_btn">Sign up</a>';
      }
      ?>
    </div>
    <div class="web-title">
      <p class="web-name">MobiTracker FAQ</p>
    </div>
