...
<html lang="en" dir="ltr">
  <head>
    ...
    <meta property="og:title" content="FAQ - MobiTracker.co" />
        ...
        <header class="playercard">
          <div class="drop" id="faqContracts">
            ...
            <div class="hidden">
              ...
              <p class="playerbio"><span class="highlight">Q: Why do I have to choose between Lawful and Unlawful contracts?</span><br><br>A: In an effort to stop poaching we lock your choice of contract type for 14 days. After two weeks you will be able to change your contract type. You can do this every 2 weeks as much as you like.</p>
        ...
        <header class="playercard">
          <div class="drop" id="faqDiscordbot">
            ...
            <div class="hidden">
              ...
              <p class="playerbio"><span class="highlight">Q: What does the discord bot do?</span><br><br>A: Allows users to search players, see their rating and organization information as well as search Lawful contracts. Unlawful contracts are not searchable through the discord bot.</p>
