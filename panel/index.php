    ...
    <div id="canvas">
      ...
      <div class="container-header">
        <div class="centerCont">
          ...
          <div>
            <div class="players" data-value="0" data-preset="fan"></div>
            <p>Player Scanner</p>
          </div>
          <div>
            <div class="crawler" data-value="0" data-preset="fan"></div>
            <p>Org Crawler</p>
          </div>
          <div>
            <div class="scanner" data-value="0" data-preset="fan"></div>
            <p>Org Scanner</p>
          </div>
        </div>
      </div>
